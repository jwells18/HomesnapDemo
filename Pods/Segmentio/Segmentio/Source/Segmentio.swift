...
public typealias SegmentioIndexPressedCallback = ((_ segmentio: Segmentio, _ selectedSegmentioIndex: Int) -> Void)
...
open class Segmentio: UIView {
    ...
    open var indexPressed: SegmentioIndexPressedCallback?
...
extension Segmentio: UICollectionViewDelegate {
    ...
    public func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        //Index Pressed Callback
        indexPressed?(self, selectedSegmentioIndex)
    }
